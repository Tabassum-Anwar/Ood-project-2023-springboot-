...
public class Orders {
    ...
    public Orders(Long id, Date date, double totalPrice, String address, boolean payment, String paymentType, Customer customer, List<OrderDetails> orderDetailList) {
        this.id = id;
        this.date = date;
